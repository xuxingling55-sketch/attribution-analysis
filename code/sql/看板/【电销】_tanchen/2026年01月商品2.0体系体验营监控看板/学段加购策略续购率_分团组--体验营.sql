drop table if exists tmp.tanchen_v2_tunke_zhuanhualv_group_tyy;
create table if not exists tmp.tanchen_v2_tunke_zhuanhualv_group_tyy(
  paid_day string,
  group_name string,
  auth_name string,
  qw_user_name string,
...
insert overwrite table tmp.tanchen_v2_tunke_zhuanhualv_group_tyy partition(dt)
select 
