drop table if exists tmp.tanchen_v2_duohai_zhuanhualv_all_tyy;
create table if not exists tmp.tanchen_v2_duohai_zhuanhualv_all_tyy(
paid_day string,
group_label string,
...
insert overwrite table tmp.tanchen_v2_duohai_zhuanhualv_all_tyy partition(dt)
  select 
