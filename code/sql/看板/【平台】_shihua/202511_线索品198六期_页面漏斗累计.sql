...
left join
    (-- 营销页面进入
        ...
        and (!(from_page_name regexp 'purchase|member-mytab-coursePromotion') or from_page_name is null or from_page_name='null' or from_page_name='') -- 排除电销推送和我的tab
        group by 
          1,2
    ) as r3 on r1.day=r3.day and r1.u_user=r3.u_user
group by 1,2,3,4
