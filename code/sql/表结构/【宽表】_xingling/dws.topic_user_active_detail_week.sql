-- =====================================================
-- 用户活跃周汇总表 dws.topic_user_active_detail_week
-- =====================================================
--
-- 【表粒度】
...
COMMENT '一个用户一个下载渠道一个产品id一个活跃端口一个手机品牌一个手机型号一个sn_code一条记录https://guanghe.feishu.cn/sheets/IMQ5sYxhyhVUrItjifvcFmnInoe?sheet=XUYogj'
