...
--   场景条件：
--   - status = '支付成功'                    -- 看营收时加
--   - order_amount >= 39                     -- 正价订单（不推荐用 is_normal_price）
