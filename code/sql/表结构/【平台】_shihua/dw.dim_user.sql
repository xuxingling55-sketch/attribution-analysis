-- =====================================================
-- 公用- 用户基础信息表 dw.dim_user
-- =====================================================
--
-- 【表粒度】
--   一个用户一条记录（维度表；u_user / user_sk；无分区）
--
-- 【业务定位】
--   - 【归属】公用 / 用户基础信息表。
...
CREATE EXTERNAL TABLE `dw`.`dim_user` (
  ...
  `learning_time` int COMMENT '学习时长（源导出缺注）',
...
LOCATION 'tos://yc-data-platform/user/hive/warehouse/dw.db/dim_user'
